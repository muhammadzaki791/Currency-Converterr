...
if (isNaN(value1) || isNaN(value2) || isNaN(value3)) {
    console.log(chalk.red.yellowBright.italic("Error: Ensure your input consists of valid numbers for optimal results."));
}
else {
    let entervalue = q1.amount;
    let finalValue = value3 * value2;
    console.log(chalk.yellow.bgBlack(`Your  ${q1.amount}  ${q1.basecurrency} is converted to ${finalValue.toFixed(0)} ${q1.tocurrency} successfully`));
}
